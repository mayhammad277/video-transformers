...
dataset =JointDataset(tokenizer=tokenizer,file_path='/ibex/scratch/projects/c2090/anet_may/prep_featss3d/sep_joined_sents_tr.txt',block_size=128)
...
Training_args = TrainingArguments(
    output_dir="finetuned_bert_actNet",
...
trainer.train()
trainer.save_model('finetuned_bert_actNet')
