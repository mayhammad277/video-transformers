...
masked=open('/ibex/scratch/projects/c2090/May/may_model_new_sep_one_collator_dataset/evaluations/filltered_sets/masked_nn_test.txt','r')
masked=masked.read().splitlines()[:1000000]

filled_list=pred_mask_for_sents(masked,Visual_text_Model,tokenizer)
with open('/ibex/scratch/projects/c2090/May/may_model_new_sep_one_collator_dataset/evaluations/filltered_sets/mask_nn_preds_test_s_toy.json','w') as f:
  json.dump(filled_list,f)

masked_vb=open('/ibex/scratch/projects/c2090/May/may_model_new_sep_one_collator_dataset/evaluations/filltered_sets/masked_vb_test.txt','r')
masked_vb=masked_vb.read().splitlines()[:1000000]


filled_list=pred_mask_for_sents(masked_vb,Visual_text_Model,tokenizer)
with open('/ibex/scratch/projects/c2090/May/may_model_new_sep_one_collator_dataset/evaluations/filltered_sets/mask_vb_preds_test_s_toy.json','w') as f:
  json.dump(filled_list,f)
